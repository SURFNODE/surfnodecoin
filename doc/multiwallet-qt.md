...
In order to support loading of multiple wallets in surfnode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is surfnode.cpp.
...
Changes to surfnode.cpp
----------------------
surfnode.cpp is the entry point into surfnode-qt, and as such, will require some minor modifications to provide hooks for
