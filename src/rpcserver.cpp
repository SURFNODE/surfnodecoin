...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SURFNODE server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SURFNODE server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SFN features */
        {"surfnode", "masternode", &masternode, true, true, false},
        {"surfnode", "listmasternodes", &listmasternodes, true, true, false},
        {"surfnode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"surfnode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"surfnode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"surfnode", "masternodedebug", &masternodedebug, true, true, false},
        {"surfnode", "startmasternode", &startmasternode, true, true, false},
        {"surfnode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"surfnode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"surfnode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"surfnode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"surfnode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"surfnode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"surfnode", "mnbudget", &mnbudget, true, true, false},
        {"surfnode", "preparebudget", &preparebudget, true, true, false},
        {"surfnode", "submitbudget", &submitbudget, true, true, false},
        {"surfnode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"surfnode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"surfnode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"surfnode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"surfnode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"surfnode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"surfnode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"surfnode", "checkbudgets", &checkbudgets, true, true, false},
        {"surfnode", "mnsync", &mnsync, true, true, false},
        {"surfnode", "spork", &spork, true, true, false},
        {"surfnode", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"surfnode", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use surfnoded, or the -server option to surfnode-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> surfnode-cli " + methodname + " " + args + "\n";
}
