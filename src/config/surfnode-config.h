/* src/config/surfnode-config.h.  Generated from surfnode-config.h.in by configure.  */
/* src/config/surfnode-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef surfnode_CONFIG_H

#define surfnode_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.surfnode.online"

/* Define to the full name of this package. */
#define PACKAGE_NAME "surfnode Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "surfnode Core 1.2.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "surfnode"
