...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("SFN RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  surfnode-cli [options] <command> [params]  " + _("Send command to SFN") + "\n" +
                        "  surfnode-cli [options] help                " + _("List commands") + "\n" +
                        "  surfnode-cli [options] help <command>      " + _("Get help for a command") + "\n";
