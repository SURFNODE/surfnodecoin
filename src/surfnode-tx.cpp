...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SFN surfnode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  surfnode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded surfnode transaction") + "\n" +
                               "  surfnode-tx [options] -create [commands]   " + _("Create hex-encoded surfnode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded surfnode transaction
