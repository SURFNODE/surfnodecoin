...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SURFNODE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and surfnode: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SFN"), this);
    aboutAction->setStatusTip(tr("Show information about SFN"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SURFNODE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SURFNODE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SURFNODE addresses"));
    ...
    openAction->setStatusTip(tr("Open a SURFNODE: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SFN help message to get a list with possible SURFNODE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SFN client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SURFNODE network", "", count));
}
...
{
    QString strTitle = tr("SFN"); // default title
