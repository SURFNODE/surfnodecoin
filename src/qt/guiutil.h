...
/** Utility functions used by the SURFNODE Qt UI.
 */
namespace GUIUtil
{
...
// Render SURFNODE addresses in monospace font
...
// Parse "surfnode:" URI into recipient object, return true on successful parsing
