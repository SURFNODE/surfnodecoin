...
RESOURCES += src/qt/surfnode.qrc src/qt/surfnode_locale.qrc

TRANSLATIONS += src/qt/locale/surfnode_bg.ts \
                src/qt/locale/surfnode_de.ts \
                src/qt/locale/surfnode_en.ts \
                src/qt/locale/surfnode_es.ts \
                src/qt/locale/surfnode_fi.ts \
                src/qt/locale/surfnode_fr.ts \
                src/qt/locale/surfnode_it.ts \
                src/qt/locale/surfnode_ja.ts \
                src/qt/locale/surfnode_pl.ts \
                src/qt/locale/surfnode_pt.ts \
                src/qt/locale/surfnode_ru.ts \
                src/qt/locale/surfnode_sk.ts \
                src/qt/locale/surfnode_sv.ts \
                src/qt/locale/surfnode_vi.ts \
                src/qt/locale/surfnode_zh_CN.ts \
                src/qt/locale/surfnode_zh_TW.ts
